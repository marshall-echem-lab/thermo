...
| Property | Value |
|---|---|
| Water heat capacity ($C_P$) | 4.18 kJ kg⁻¹ K⁻¹ |
| NaOH heat capacity ($C_P$) | 1.46 kJ kg⁻¹ K⁻¹ |
| 10 wt% NaOH solution heat capacity ($C_P$) | 3.90 kJ kg⁻¹ K⁻¹ |
...
Assumptions: perfectly insulated vessel ($\dot{Q}=0$); no work ($\dot{W}=0$); no flow — a batch system; integrating from mixing to equilibrium gives $\Delta H_{sys} = 0$.

Energy balance (each component brought from its initial temperature to the common final temperature $T_f$):

$$m_{NaOH}\,C_{P,NaOH}\,(T_f - T_{NaOH}) + m_{water}\,C_{P,water}\,(T_f - T_{water}) = 0$$

Solving for $T_f$:

$$T_f = \frac{m_{NaOH}\,C_{P,NaOH}\,T_{NaOH} + m_{water}\,C_{P,water}\,T_{water}}{m_{NaOH}\,C_{P,NaOH} + m_{water}\,C_{P,water}}$$

$$T_f = \frac{(0.1)(1.46)(20) + (0.9)(4.18)(0)}{(0.1)(1.46) + (0.9)(4.18)} = \frac{2.92}{3.908} = 0.75\ ^\circ\text{C}$$
...
$$$m_{sys,i}H_{sys,i}$ = m_{NaOH}\,C_{P,NaOH}\,(T_{NaOH}-0) + m_{water}\,C_{P,water}\,(T_{water}-0)$$

$m_{sys,f}H_{sys,f}$ is the enthalpy of the solution at its actual final temperature, relative to 0 °C and the un-mixed components:

$$m_{sys,f}H_{sys,f} = m_{solution}\,C_{P,solution}\,(T_{actual}-0) + m_{solution}\,\Delta H_{dissolution}$$

The heat of dissolution ($\Delta H_{dissolution}$) is therefore:

$$m_{solution}\,C_{P,solution}\,(T_{actual}-0) + m_{solution}\,\Delta H_{dissolution} - m_{NaOH}\,C_{P,NaOH}\,(T_{NaOH}-0) + m_{water}\,C_{P,water}\,(T_{water}-0) = 0$$ 

$$ m_{solution}\,\Delta H_{dissolution} = m_{NaOH}\,C_{P,NaOH}\,(T_{NaOH}-0) + m_{water}\,C_{P,water}\,(T_{water}-0) - m_{solution}\,C_{P,solution}\,(T_{actual}-0)$$
$$ m_{solution}\,\Delta H_{dissolution} = (0.1)(1.46)(20-0) + (0.9)(4.18)(0-0) - (1)(3.9)(30-0) = - 114.08 \ \text{kJ}$$

$m_{solution}\,\Delta H_{dissolution} = -114.08$ kJ for the 100 g of NaOH dissolved. So on a mass basis of NaOH, the heat of dissolution is:

$$\Delta H_{dissolution} = -1141 \ \text{kJ/kg}$$
